...
const CustomerService = ({ onNavigate, searchQuery }) => {
  ...
  const topics = [
    { id: 'appointments', name: 'Appointment Management', icon: '📅', color: 'blue' },
    { id: 'scheduling', name: 'Scheduling', icon: '⏰', color: 'green' },
    { id: 'confirmation', name: 'Confirmation', icon: '✅', color: 'yellow' },
    { id: 'cancellation', name: 'Cancellation', icon: '❌', color: 'red' },
  ...
  const allServiceTopics = [...serviceTopics, ...urgentTopics];
